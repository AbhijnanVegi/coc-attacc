...
def check_collision(object1: GameObject, object2: GameObject)->bool:
    if not object1 or not object2:
        return False
    collisionX = object1.position[0] + object1.size[0] >= object2.position[0] and object1.position[0] <= object2.position[0] + object2.size[0]
    collisionY = object1.position[1] + object1.size[1] >= object2.position[1] and object1.position[1] <= object2.position[1] + object2.size[1]
...
def check_inside(object1 : GameObject, object2: GameObject) -> bool:
    if not object1 or not object2:
        return False
    x = object1.position[0] + object1.size[0] > object2.position[0] and object1.position[0] < object2.position[0] + object2.size[0]
    y = object1.position[1] + object1.size[1] > object2.position[1] and object1.position[1] < object2.position[1] + object2.size[1]
